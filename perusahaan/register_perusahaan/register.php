    ...
    <div class="form-container">
        <div class="form-header">
            <div>
                ...
                <p>Lengkapi 6 data utama untuk pendaftaran perusahaan</p>
            </div>
            ...
            <div class="form-grid">
                <div class="input-box">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="username" placeholder="Username mitra" required>
                    </div>
                </div>
                <div class="input-box">
            ...
            <div class="form-grid">
                <div class="input-box full-width">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="nama_perusahaan" placeholder="Contoh: PT. Maju Bersama" required>
                    </div>
                </div>
                ...
                <div class="input-box full-width">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="contact_person" placeholder="Nama lengkap penanggung jawab magang" required>
                    </div>
                </div>
            </div>

            <button type="submit" name="submit" class="btn-submit">Simpan Data Perusahaan</button>
        </form>
    </div>
</main>

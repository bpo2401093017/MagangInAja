   ...
   $nama_file_baru = $foto_lama; 
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] === 0) {
        ...
        if ($ukuran <= 2000000) {
            ...
            $tujuan = "../img/profile_jurusan/" . $nama_file_baru;

            if (move_uploaded_file($tmp_name, $tujuan)) {
                // Hapus foto lama di folder yang sama jika ada
                if ($foto_lama != '' && $foto_lama != 'default.png' && file_exists("../img/profile_jurusan/" . $foto_lama)) {
                    unlink("../img/profile_jurusan/" . $foto_lama);
                }
            } 
        } else {

...
// 1. Proteksi halaman (Sudah benar)
...
$query = "SELECT username, nim, email, no_hp, nama_jurusan, nama_prodi, foto FROM users WHERE id_user = '$id_user'";
...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_url; ?>css/profile_mahasiswa.css">
</head>
<body>
